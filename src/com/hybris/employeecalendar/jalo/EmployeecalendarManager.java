...
/**
 * This is the extension manager of the Employeecalendar extension.
 */
public class EmployeecalendarManager extends GeneratedEmployeecalendarManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmployeecalendarManager.class.getName());
	 ...
	 */
	public static EmployeecalendarManager getInstance()
	{
		return (EmployeecalendarManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmployeecalendarConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmployeecalendarManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmployeecalendarManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmployeecalendarManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmployeecalendarManager called, current tenant: " + getTenant().getTenantID());
		}
	}
